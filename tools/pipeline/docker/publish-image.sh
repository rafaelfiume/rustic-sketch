...
main() {
  ...
  run_command "docker push rafaelfiume/rustic-sketch:latest"
  run_command "docker push rafaelfiume/rustic-sketch:$VERSION"
  if [ "${CIRCLE_BRANCH:-}" = "main" ]; then
    run_command "docker push rafaelfiume/rustic-sketch:stable"
  else
